...
import { getWeatherDetailPrompt, getWeatherLocation, handleWeatherRequest } from "../service/weather-service";
import { defaultMessage } from "../const/settings/chatbot-config.const";
